...
public class Q4 extends javax.swing.JFrame {
    ...
    public void setTextArea(List<String> name,String op){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter the list off number");

        jTextField1.setText("10 -5 20");
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        int op=JOptionPane.showConfirmDialog(null,"Do you really wanna exit application",
