...
public class Bang extends javax.swing.JFrame {
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        if(JOptionPane.showConfirmDialog(null,"Ban co chac mun thoat","thoat",
    ...
    public void SuaTable(String ma,String ten,int tuoi,double  diem){
        t.setValueAt(ma,getSelectedRow(),0);
        t.setValueAt(ten,getSelectedRow(),1);
        t.setValueAt(tuoi,getSelectedRow(),2);
        t.setValueAt(diem,getSelectedRow(),3);
    }
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int dem=getSelectedRow();
        if(dem<0 || dem>getRowCount()){
            JOptionPane.showMessageDialog(rootPane,"ban phai chon hang truoc");
            return;
        }
